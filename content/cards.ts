...
id: 'everdeck',
  ...
  {
    id: 'neuromaker',
    hook: 'Turning noisy EEG into something a person can actually read.',
    name: 'Neuromaker (BCI)',
    status: 'biotech academy',
    line: "A brain–computer-interface app built with my school's biotech academy. It reads EEG brainwaves through a headset and flags unusually high or low activity — spotting that normally takes clinical equipment, so the aim was something accessible that surfaces the anomalies.",
