...
const ART: Record<string, React.ReactNode> = {
  ...
  talk: (
    <>
      ...
      <path {...STROKE} d="M28 40h44" transform="translate(8 2)" />
      <path {...STROKE} d="M28 52h30" transform="translate(8 2)" />
      <path {...STROKE} d="M78 84h22a6 6 0 0 0 6-6v-8a6 6 0 0 0-6-6H84a6 6 0 0 0-6 6v8l-6 10 6-4Z" transform="translate(2 6)" />
    </>
  ),
  ...
  quote: (
    <>
      ...
      <path {...STROKE} d="M42 88c4-6 8 4 12-2s8 2 14-2" />
    </>
  ),
  ...
  preview: (
    <>
      ...
      <path {...STROKE} d="M24 56h30" strokeWidth={6} />
      <path {...STROKE} d="M24 74h36" />
      <path {...STROKE} d="M88 66l14 14-8 1-3 8-3-23Z" transform="translate(-4 -4)" />
    </>
  ),
  ...
  keys: (
    <>
      ...
      <path {...STROKE} d="M60 16a12 12 0 1 0 .01 0Z" transform="translate(-14 4)" />
      <path {...STROKE} d="M54 38v18l6 6" transform="translate(-8 -6)" />
    </>
  ),
};
